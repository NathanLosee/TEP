...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('primary_color', sa.String(7), nullable=False, server_default='#4CAF50'),
        sa.Column('secondary_color', sa.String(7), nullable=False, server_default='#81C784'),
        sa.Column('accent_color', sa.String(7), nullable=False, server_default='#FFEB3B'),
        ...
        sa.Column('company_name', sa.String(255), nullable=False, server_default='TEP Timeclock'),
    ...
    op.execute(
        ...
        "VALUES (1, '#4CAF50', '#81C784', '#FFEB3B', 'TEP Timeclock')"
    )
