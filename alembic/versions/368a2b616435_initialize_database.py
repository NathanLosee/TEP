...
Revision ID: 368a2b616435
Revises: 
Create Date: 2025-05-20 06:54:18.598874
...
def upgrade() -> None:
    ...
    sa.Column('badge_number', sa.String(), nullable=False),
    sa.ForeignKeyConstraint(['badge_number'], ['employees.badge_number'], onupdate='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('badge_number', sa.String(), nullable=False),
    sa.ForeignKeyConstraint(['badge_number'], ['users.badge_number'], onupdate='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
